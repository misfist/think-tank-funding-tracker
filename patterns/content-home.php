...
<section class="wp-block-group section section__top-10">
    <!-- wp:group {"metadata":{"name":"foreign-government","patternName":"ttft/data-table-top-10-foreign"},"className":"section-table foreign","layout":{"type":"grid","columnCount":2,"minimumColumnWidth":"13rem"}} -->
    ...
    <!-- wp:group {"metadata":{"name":"pentagon-contractor","patternName":"ttft/data-table-top-10-pentagon"},"className":"section-table pentagon","layout":{"type":"grid","columnCount":2,"minimumColumnWidth":"13rem"}} -->
    ...
    <!-- wp:group {"metadata":{"name":"u-s-government","patternName":"ttft/data-table-top-10-domestic"},"className":"section-table domestic","layout":{"type":"grid","columnCount":2,"minimumColumnWidth":"17rem"}} -->
