...
<!-- wp:group {"metadata":{"name":"Sub-header Wrapper"},"align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|10"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--10)">
    <!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
    <div class="wp-block-group alignwide"><!-- wp:boldblocks/breadcrumb-block {"hideCurrentPage":true} /--></div>
    <!-- /wp:group -->
</div>
<!-- /wp:group -->